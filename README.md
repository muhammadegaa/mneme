...
tools, and the mistake you keep making. Then it catches it on your next diff,
*before it ships*.
...
| `codehere` (1,456 commits) | n/a | **`var` ×3, empty-catch ×2** | real: `var onSpend=…`, `}catch(e){}` in the commits |
